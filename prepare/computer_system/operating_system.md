...
![调用之前的栈](../imgs/ia32_stack_before_call.png)
...
![调用之后的栈](../imgs/ia32_stack_after_call.webp)

![调用之后开始执行的栈](../imgs/ia32_stack_after_call_and_exec.webp)
...
![调用之后返回的栈](../imgs/ia32_stack_after_ret.webp)
